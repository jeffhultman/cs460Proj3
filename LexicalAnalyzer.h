...
class LexicalAnalyzer 
{
	...
	ofstream debug;
	void ReportFunctionEntered (const string & function, token_type t);
	void ReportFunctionExited (const string & function, token_type t);
	void ReportRuleUsed (const string & rule);
    private:
	ifstream input;
	ofstream listing;
	ofstream p2file;
